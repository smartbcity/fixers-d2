...
Annoying function
  ...
  <div>
    ...
    Body:[`BoringGetQuery`](#boring-get-query)Result:[`BoringGetQueryResult`](#boring-get-query)
  </div>
...
Probably does stuff but it's not really interesting
  ...
  <div>
    ...
    Body:[`BoringInterface`](#boring-object)Result:`Boolean`
  </div>
